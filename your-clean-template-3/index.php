...
<main>
    ...
    <div class="main4">
        <ul>
            <li><a class="active" href="#">Холодильники</a></li>
            ...
            <li><a href="#">Кофе машины</a></li>
            <li><a href="#">Вытяжки</a></li>
            <li><a href="#">Ремонт винных шкафов</a></li>
            <li><a href="#">Ремонт сигарных шкафов</a></li>
        </ul>
        <div class="main4_table">
            <div class="main4_table1"></div>
            <div class="main4_table_block">
                <p>Установка машины по уровню, снятие креплений, замена/ремонт опор</p>
                <span>от 500р</span>
            </div>
            <div class="main4_table_block">
                <p>Мелкий ремонт не включающий в себя разборку машины</p>
                <span>от 1000р</span>
            </div>
            <div class="main4_table_block">
                <p>Замена хладагента (фреона)</p>
                <span>от 2500р</span>
            </div>
            <div class="main4_table_block">
                <p>Замена ручки открывания, защелки, крепления люка, замена стекла</p>
                <span>от 700р</span>
            </div>
            <div class="main4_table_block">
                <p>Замена гидростопа, сливного шланга, патрубков, герметизация</p>
                <span>от 1400р</span>
            </div>
            <div class="main4_table_block">
                <p>Замена датчиков</p>
    ...
    <p class="main_p2">Обращаем Ваше внимание, что цены на ремонтные работы приведены без учета стоимости запчастей!</p>
    <div class="main3">
    ...
    <div class="main6">
        <div class="main6_block">
            <img src="/wp-content/themes/your-clean-template-3/img/c10238aa038b012f7555025490a18898.jpg" alt="">
            <div>
                <p class="main6_block_p1">Устранили неисправность датчика оттайки холодильника Miele KFN8767</p>
                <p class="main6_block_p2">Машинка при стирке гудела и подпрыгивала. Обзвонила не одну компанию,
                    цены называли такие, что думала: может лучше новую покупать.
                    Здесь озвучили приемлемую цифру, уже через 10 минут перезвонил мастер,
                    договорились о времени. На ремонт мастер потратил не более 30 минут, было видно,
                    что он знает, что делать, а не создает видимость.
                    На ремонт дал гарантию. Машинка работает тихо, как новенькая. Очень признательна!</p>
            </div>
        </div>
        <div class="main6_block">
            <img src="/wp-content/themes/your-clean-template-3/img/26e5f7a8e836b4a38396bf1c0826882b.jpg" alt="">
            <div>
                <p class="main6_block_p1">Устранили неисправность датчика оттайки холодильника Miele KFN8767</p>
                <p class="main6_block_p2">Невероятно, но вы нас спасли! Представляете, что такое летом в загородном доме перестает
                    работать холодильник?! У нас Мiele, и я прекрасно понимаю,
                    что не легко найти хорошего мастера и доверить ему дорогую технику.
                    Оставил заявку, перезвонил мастер, договорились о выезде.
                    Не верилось, но..приехал в тот же день, доплаты за срочность не попросил,
                    и главное, холодильник снова морозит. Спасибо мастеру Алексею! Теперь только к вам!
                </p>
            </div>
        </div>
    </div>
    <p class="main_p3">Ответы на часто задаваемые вопросы</p>
    <div class="main7">
        <div>
            <p class="main7_p1">Сколько стоит выезд инженера?</p>
            <p class="main7_p2">Выезд нашего инженера для Вас будет совершенно бесплатным независимо от срочности вызова.
                При этом во многих других сервиса Вас попросят доплатить за срочность.</p>
        </div>
        <div>
            <p class="main7_p1">Сколько стоит выезд инженера?</p>
            <p class="main7_p2">Выезд нашего инженера для Вас будет совершенно бесплатным независимо от срочности вызова.
